        ...
        <div class="masthead">
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    <h1 class="fst-italic lh-1 mb-4">Selamat Datang di Website Pengaduan Kota Bontang</h1>
                    <p class="mb-5">Pemerintah Kota Bontang mencoba menciptakan kota yang tertib dan aman</p>
                    <!-- * * * * * * * * * * * * * * *-->
